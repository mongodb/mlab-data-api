...
import org.objectlabs.mongodb.SecurityUtils;
...
public class CollectionResource extends PortalRESTResource {
  ...
  protected Object handleGet(final Map parameters, final RequestContext context)
    ...
    try {
      ...
      // TODO: This is a very tenuous test for bad data in the DB. Ideally the driver would return a
      // specific exception.
  ...
  private Object getJSONParam(final Object value, final Object defaultValue)
    ...
    try {
      ...
      // TODO:  Should be specifically catching com.mongodb.util.JSONParseException, but it's
      // package protected
      throw new ResourceException(
          HttpServletResponse.SC_BAD_REQUEST,
